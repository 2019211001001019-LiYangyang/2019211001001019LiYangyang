...
import com.LiYangyang.model.Item;
...
public class CartServlet extends HttpServlet {
    ...
    HttpSession session = request.getSession(false);//get exiting session,not creat a new one
    ...
    private void buy(HttpServletRequest request, HttpServletResponse response) throws ServletException,SQLException,IOException{
        //add items into cart
