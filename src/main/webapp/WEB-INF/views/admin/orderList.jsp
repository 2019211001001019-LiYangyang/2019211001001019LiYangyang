			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.LiYangyang.model.Order o=(com.LiYangyang.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.LiYangyang.dao.UserDao userDao=new com.LiYangyang.dao.UserDao();
						...
						<%
							...
							String paymentType=com.LiYangyang.model.Payment.findByPaymentId(con,n);
							 %>
