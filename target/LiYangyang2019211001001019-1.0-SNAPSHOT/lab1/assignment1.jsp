...
<h1> c:forEach loop to print 1 to 10</h1>
...
<h1> c:forEach loop to print list 1,3,5,7,9</h1>
<ul>
...
<h1> c:forEach loop to print 2,4,6,8,10</h1>
<ul>
...
<h1> c:forEach loop to print "one","three","five","seven","nine"  of array</h1>
<ul>
...
%>
<h1> c:forEach loop to print person name :   and persons' dog name :</h1>
<ul>
...
%>
<h1> c:forTaken loop to print all words</h1>
<ul>
